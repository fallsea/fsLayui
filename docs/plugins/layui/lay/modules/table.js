        ...
        ,success: function(res){
        	...
        	if(res["errorNo"] != "0"){
                ...
                if(!_.isEmpty(filters)){
                    var otherFunction = filters[res["errorNo"]];
          ...
          //如果table标签不存在，需要补标签
          if(that.layMain.find("table").length==0)
          {
        	  that.layTool.show();
        	  that.layMain.html('<table cellspacing="0" cellpadding="0" border="0" class="layui-table"><tbody></tbody></table>');
          }
